...
Campaign state: release candidate after a material user-directed correction. The campaign returns to complete only when `deployment-status.json` identifies the corrected publication source and records `live_audit: passed`.
